...
public class FragmentAngsuran extends Fragment {
    ...
    public static FragmentAngsuran newInstance(String movieTitle, ArrayList<String> listPrice) {
        FragmentAngsuran fragmentAction = new FragmentAngsuran();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myInflater =inflater.inflate(R.layout.fragment_angsuran, container, false);
